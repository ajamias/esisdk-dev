...
class TestNodeAndPortList(TestCase):
    ...
    def test_node_and_port_list_node_id_filter(self):
        actual = nodes.node_and_port_list(self.connection, filter_node=self.node1.id)
        expected = (
            [
                self.node1,
            ],
    ...
    def test_node_and_port_list_node_name_filter(self):
        actual = nodes.node_and_port_list(self.connection, filter_node=self.node2.name)
        expected = (
            [
                self.node2,
            ],
